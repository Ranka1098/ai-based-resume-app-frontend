  ...
  return (
    <div>
      ...
      <div
        ...
        className="w-full my-5 h-25 md:w-36 md:h-36 bg-gray-200 flex justify-center items-center cursor-pointer mt-5 border-2 border-dotted border-gray-400 rounded-md"
      >
